...
const Scores: React.FC = () => {
  ...
  const handleSortChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    setFilter(prev => ({ ...prev, sortBy: e.target.value as 'date' | 'time' | 'guesses' }));
  };
  ...
  const handleLetterToggleChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    <div className="max-w-6xl mx-auto p-4">
      ...
      <div className="bg-neutral-700 p-4 rounded-lg mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div>
            ...
            <select
              value={filter.uniqueLettersOnly === undefined ? 'all' : filter.uniqueLettersOnly ? 'unique' : 'repeats'}
      ...
      {loading ? (
        ...
        <div className="bg-neutral-700 rounded-lg p-6 text-center">
          ...
          <p className="text-gray-400 mt-2">Try adjusting your filters or play some games first!</p>
        </div>
      ) : (
        <div className="overflow-x-auto">
          <table className="w-full bg-neutral-700 rounded-lg overflow-hidden">
            ...
            <tbody>
              {scores.map(score => (
                <tr key={score.id} className="border-t border-neutral-600 hover:bg-neutral-600">
                  ...
                  <td className="p-3">{score.uniqueLettersOnly ? 'Unique Letters' : 'Repeats Allowed'}</td>
